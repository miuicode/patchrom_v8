...
.method private insertFile(Lcom/android/providers/media/MediaProvider$DatabaseHelper;Landroid/net/Uri;Landroid/content/ContentValues;IZ)J
    ...
    invoke-static {v4}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
...
.method private static updateDatabase(Landroid/database/sqlite/SQLiteDatabase;ZII)V
    ...
    .line 759
    const-string v1, "CREATE TABLE IF NOT EXISTS audio_meta (_id INTEGER PRIMARY KEY,_data TEXT UNIQUE NOT NULL,_display_name TEXT,_size INTEGER,mime_type TEXT,date_added INTEGER,date_modified INTEGER,title TEXT NOT NULL,title_key TEXT NOT NULL,sort_title TEXT NOT NULL,sort_artist TEXT NOT NULL,sort_album TEXT NOT NULL,duration INTEGER,artist_id INTEGER,composer TEXT,album_id INTEGER,track INTEGER,year INTEGER CHECK(year!=0),is_ringtone INTEGER,is_music INTEGER,is_alarm INTEGER,is_notification INTEGER);"
    ...
    .line 808
    const-string v1, "CREATE VIEW IF NOT EXISTS artist_info AS SELECT artist_id AS _id, artist, sort_artist, artist_key, COUNT(DISTINCT album) AS number_of_albums, COUNT(*) AS number_of_tracks FROM audio WHERE is_music=1 GROUP BY sort_artist;"

    invoke-virtual {p0, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 819
    const-string v1, "CREATE VIEW IF NOT EXISTS album_info AS SELECT audio.album_id AS _id, album, sort_album, album_key, MIN(year) AS minyear, MAX(year) AS maxyear, artist, artist_id, artist_key, count(*) AS numsongs,album_art._data AS album_art FROM audio LEFT OUTER JOIN album_art ON audio.album_id=album_art.album_id WHERE is_music=1 GROUP BY audio.album_id;"
    ...
    sget-object v2, Lcom/android/providers/media/MediaProvider;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    const-string v3, "system_ringtone"

    invoke-static {v2, v3}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/android/providers/media/MediaProvider;->updateRingtone(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "system_ringtone_2"
    ...
    const-string v3, "system_notification_sound"
    ...
    .line 1048
    const-string v0, "CREATE VIEW IF NOT EXISTS search AS SELECT _id,\'artist\' AS mime_type,artist,NULL AS album,NULL AS title,NULL AS sort_title,NULL AS sort_artist,NULL AS sort_album,artist AS text1,NULL AS text2,number_of_albums AS data1,number_of_tracks AS data2,artist_key AS match,\'content://media/external/audio/artists/\'||_id AS suggest_intent_data,1 AS grouporder FROM artist_info WHERE (artist!=\'<unknown>\') UNION ALL SELECT _id,\'album\' AS mime_type,artist,album,NULL AS title,NULL AS sort_title,NULL AS sort_artist,NULL AS sort_album,album AS text1,artist AS text2,NULL AS data1,NULL AS data2,artist_key||\' \'||album_key AS match,\'content://media/external/audio/albums/\'||_id AS suggest_intent_data,2 AS grouporder FROM album_info WHERE (album!=\'<unknown>\') UNION ALL SELECT searchhelpertitle._id AS _id,mime_type,artist,album,title,sort_title,sort_artist,sort_album,title AS text1,artist AS text2,NULL AS data1,NULL AS data2,artist_key||\' \'||album_key||\' \'||title_key AS match,\'content://media/external/audio/media/\'||searchhelpertitle._id AS suggest_intent_data,3 AS grouporder FROM searchhelpertitle WHERE (title != \'\') "
    ...
    .line 1239
    const-string v0, "CREATE VIEW IF NOT EXISTS artist_info AS SELECT artist_id AS _id, artist, artist_key,  sort_artist,COUNT(DISTINCT album_key) AS number_of_albums, COUNT(*) AS number_of_tracks FROM audio WHERE is_music=1 GROUP BY sort_artist;"
    ...
    .line 1461
    const-string v0, "DROP INDEX IF EXISTS sort_title_idx"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 1462
    const-string v0, "DROP INDEX IF EXISTS sort_artist_idx"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 1463
    const-string v0, "DROP INDEX IF EXISTS sort_album_idx"
    ...
    .line 1471
    const-string v0, "CREATE INDEX sort_title_idx ON files(sort_title);"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 1472
    const-string v0, "CREATE INDEX sort_artist_idx ON files(sort_artist);"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 1473
    const-string v0, "CREATE INDEX sort_album_idx ON files(sort_album);"
...
.method private static updateRingtone(Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    .parameter
    .parameter
    ...
    .prologue
    .line 1644
    sget-object v0, Lcom/android/providers/media/MediaProvider;->mContext:Landroid/content/Context;
...
.method public onCreate()Z
    ...
    sput-object v0, Lcom/android/providers/media/MediaProvider;->mContext:Landroid/content/Context;
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v6}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/android/providers/media/AudioLocaleUtils;->getSortKey(Ljava/lang/String;)Ljava/lang/String;
