...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/media/AudioService$SetAudioFuncThread;,
...
.field private static final CONTEXT_NORMAL:I = 0x0

.field private static final CONTEXT_SWITCH_BLUETOOTHSCO:I = 0x2

.field private static final CONTEXT_SWITCH_SPEAKER:I = 0x1

.field protected static final DEBUG_RC:Z = false

.field private static final IN_VOICE_COMM_FOCUS_ID:Ljava/lang/String; = "AudioFocus_For_Phone_Ring_And_Calls"

.field private static final MODEM_MSG_DELAY:I = 0x12c
...
# instance fields
.field final KT_RIL_REQ_CHANGE_VOLUME:I

.field final KT_RIL_REQ_SET_AUDIO_MODE:I
...
.field private mModemMsgSendTask:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v3, p0, Landroid/media/AudioService;->KT_RIL_REQ_CHANGE_VOLUME:I

    .line 3878
    const/16 v3, 0x13

    iput v3, p0, Landroid/media/AudioService;->KT_RIL_REQ_SET_AUDIO_MODE:I
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mModemMsgSendTask:Ljava/lang/Runnable;
    ...
    const-string v4, "AudioService_ModemMsgSend"

    invoke-direct {v3, p0, v4}, Landroid/media/AudioService$2;-><init>(Landroid/media/AudioService;Ljava/lang/String;)V

    iput-object v3, p0, Landroid/media/AudioService;->mHandlerThread:Landroid/os/HandlerThread;

    .line 381
    iget-object v3, p0, Landroid/media/AudioService;->mHandlerThread:Landroid/os/HandlerThread;
...
.method static synthetic access$500(Landroid/media/AudioService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$502(Landroid/media/AudioService;Landroid/os/Handler;)Landroid/os/Handler;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 92
    iput-object p1, p0, Landroid/media/AudioService;->mHandler:Landroid/os/Handler;
...
.method static synthetic access$5900(Landroid/media/AudioService;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 92
    invoke-direct {p0, p1}, Landroid/media/AudioService;->setModemOutput(I)V
...
.method static synthetic access$7300(Landroid/media/AudioService;[B)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 92
    invoke-direct {p0, p1}, Landroid/media/AudioService;->clearBuffer([B)V
...
.method static synthetic access$7400(Landroid/media/AudioService;)V
    ...
    .prologue
    .line 92
    invoke-direct {p0}, Landroid/media/AudioService;->setModemOutputLocked()V
...
.method static synthetic access$7500(Landroid/media/AudioService;)V
    ...
    .prologue
    .line 92
    invoke-direct {p0}, Landroid/media/AudioService;->restoreModemStreamVolumes()V
...
.method private clearBuffer([B)V
    .locals 2
    .parameter "buff"
...
.method private restoreModemStreamVolumes()V
    .locals 6
    ...
    const-string v5, "--->>> restore modem stream volumes:: enter..."
    ...
    invoke-static {v3, v4, v5}, Landroid/media/AudioSystem;->initStreamVolume(III)I
...
.method private setModemOutput(I)V
    .locals 4
    .parameter "context"
    ...
    const-string v1, "--->>> 111 mHandler == null"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3971
    :cond_0
    iget-object v0, p0, Landroid/media/AudioService;->mModemMsgSendTask:Ljava/lang/Runnable;
    ...
    const-string v1, "--->>> 222 mModemMsgSendTask == null"
    ...
    iget-object v1, p0, Landroid/media/AudioService;->mModemMsgSendTask:Ljava/lang/Runnable;
...
.method private setModemOutputLocked()V
    .locals 8
    ...
    .line 4014
    .local v2, KT_RIL_AUDIO_OUTPUT_NORMAL:I
    const/4 v1, 0x1

    .line 4015
    .local v1, KT_RIL_AUDIO_OUTPUT_HEADSET:I
    const/4 v3, 0x2

    .line 4016
    .local v3, KT_RIL_AUDIO_OUTPUT_SPEAKER:I
    const/4 v0, 0x3

    .line 4017
    .local v0, KT_RIL_AUDIO_OUTPUT_BTSCO:I
    const/4 v4, 0x0

    .line 4019
    .local v4, nAudioMode:I
    ...
    const-string v7, "--->>> setModemOutput..."
    ...
    const-string v7, "--->>> setModemOutput::AudioMode = SPEAKER"
    ...
    :cond_0
    :goto_0
    new-instance v5, Landroid/media/AudioService$SetAudioFuncThread;

    const/16 v6, 0x13

    invoke-direct {v5, p0, v6, v4}, Landroid/media/AudioService$SetAudioFuncThread;-><init>(Landroid/media/AudioService;II)V
    ...
    .line 4030
    :cond_3
    iget v6, p0, Landroid/media/AudioService;->mForcedUseForComm:I
    ...
    const-string v7, "--->>> setModemOutput::AudioMode = BTSCO"
    ...
    const-string v7, "--->>> setModemOutput::AudioMode = NORMAL(force none with bt sco)"
    ...
    const-string v7, "--->>> setModemOutput::AudioMode = HEADSET"
    ...
    const-string v7, "--->>> setModemOutput::AudioMode = NORMAL"
...
.method private setModemVolumeInfo(II)V
    .locals 7
    .parameter "stream"
    .parameter "index"
    ...
    const-string v4, "--->>> setModemVolumeInfo..."
    ...
    const-string v4, "--->>> setModemVolumeInfo::device = WIRED_HEADSET"
    ...
    .line 3946
    .end local v0           #hsVolume:[I
    .local v2, volume:I
    :goto_0
    if-ne p1, v5, :cond_3

    iget v3, p0, Landroid/media/AudioService;->mForcedUseForComm:I
    ...
    const-string v4, "--->>> really change Modem Volume..."

    invoke-static {v3, v4}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3951
    new-instance v1, Landroid/media/AudioService$SetAudioFuncThread;

    const/16 v3, 0x12

    invoke-direct {v1, p0, v3, v2}, Landroid/media/AudioService$SetAudioFuncThread;-><init>(Landroid/media/AudioService;II)V
    ...
    const-string v4, "--->>> setModemVolumeInfo::device = no wired headset or headphone"
...
.method private setStreamVolumeIndex(II)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/media/AudioService;->setModemVolumeInfo(II)V
...
.method public setBluetoothScoOn(Z)V
    ...
    invoke-direct {p0, v0}, Landroid/media/AudioService;->setModemOutput(I)V
...
.method setModeInt(ILandroid/os/IBinder;I)I
    ...
    invoke-direct {p0, v9}, Landroid/media/AudioService;->setModemOutput(I)V
...
.method public setSpeakerphoneOn(Z)V
    ...
    .line 1331
    invoke-direct {p0, v4}, Landroid/media/AudioService;->setModemOutput(I)V
