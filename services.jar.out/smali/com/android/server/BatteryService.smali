...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/BatteryService$TemperatureQueue;,
...
.field private static final MSG_TEMPERATURE_CHANGED:I = 0x1

.field private static OBSERVE_DURATION:J = 0x0L

.field private static final TAG:Ljava/lang/String; = null

.field private static final TEMPERATURE_CHANGED_ACTION:Ljava/lang/String; = "ktouch.intent.action.TEMPERATURE_CHANGED"
...
.field private mQueue:Lcom/android/server/BatteryService$TemperatureQueue;

.field private mSendHighTempeIntent:Z

.field private mSendNormalTempeIntent:Z

.field private mSentLowBatteryBroadcast:Z

.field private mUsbOnline:Z

.field private tempeChangedIntent:Landroid/app/PendingIntent;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/android/server/BatteryService;->OBSERVE_DURATION:J
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 153
    iput-boolean v5, p0, Lcom/android/server/BatteryService;->mSendHighTempeIntent:Z

    .line 154
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->mSendNormalTempeIntent:Z

    .line 155
    new-instance v3, Lcom/android/server/BatteryService$TemperatureQueue;

    invoke-direct {v3, p0}, Lcom/android/server/BatteryService$TemperatureQueue;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v3, p0, Lcom/android/server/BatteryService;->mQueue:Lcom/android/server/BatteryService$TemperatureQueue;

    .line 156
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->mBootCompleted:Z

    .line 157
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->mObserving:Z
    ...
    iput-object v3, p0, Lcom/android/server/BatteryService;->mPowerSupplyObserver:Landroid/os/UEventObserver;
    ...
    const-string v3, "ktouch.intent.action.TEMPERATURE_CHANGED"
    ...
    iput-object v3, p0, Lcom/android/server/BatteryService;->tempeChangedIntent:Landroid/app/PendingIntent;
    ...
    new-instance v4, Lcom/android/server/BatteryService$BootCompletedReceiver;

    const/4 v5, 0x0

    invoke-direct {v4, p0, v5}, Lcom/android/server/BatteryService$BootCompletedReceiver;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V
    ...
    .line 203
    iget-object v3, p0, Lcom/android/server/BatteryService;->mPowerSupplyObserver:Landroid/os/UEventObserver;

    const-string v4, "SUBSYSTEM=power_supply"
    ...
    .line 211
    :cond_0
    sget-object v3, Lcom/android/server/BatteryService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    sput-object v3, Lcom/android/server/BatteryService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$002(Lcom/android/server/BatteryService;Landroid/app/AlarmManager;)Landroid/app/AlarmManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 89
    iput-object p1, p0, Lcom/android/server/BatteryService;->mAlarmManager:Landroid/app/AlarmManager;
...
.method static synthetic access$500(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$TemperatureQueue;
    .locals 1
    .parameter "x0"

    .prologue
    .line 89
    iget-object v0, p0, Lcom/android/server/BatteryService;->mQueue:Lcom/android/server/BatteryService$TemperatureQueue;
...
.method static synthetic access$600(Lcom/android/server/BatteryService;)V
    ...
    .prologue
    .line 89
    invoke-direct {p0}, Lcom/android/server/BatteryService;->sendTempeStatBroadcastOrNot()V
...
.method private processValues()V
    ...
    .line 469
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mObserving:Z

    if-nez v0, :cond_a

    .line 470
    iget-object v0, p0, Lcom/android/server/BatteryService;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    sget-wide v4, Lcom/android/server/BatteryService;->OBSERVE_DURATION:J

    add-long/2addr v2, v4

    sget-wide v4, Lcom/android/server/BatteryService;->OBSERVE_DURATION:J

    iget-object v6, p0, Lcom/android/server/BatteryService;->tempeChangedIntent:Landroid/app/PendingIntent;
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mObserving:Z
...
.method private sendTempeStatBroadcastOrNot()V
    .locals 5
    ...
    .line 323
    iget-object v2, p0, Lcom/android/server/BatteryService;->mQueue:Lcom/android/server/BatteryService$TemperatureQueue;

    invoke-virtual {v2}, Lcom/android/server/BatteryService$TemperatureQueue;->isHigh()Z

    move-result v2

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mSendHighTempeIntent:Z

    if-eqz v2, :cond_1

    .line 324
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->mSendHighTempeIntent:Z

    .line 325
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mSendNormalTempeIntent:Z

    .line 326
    const-string v2, "TestBattery"

    const-string v3, "start send broadcast high temperature"
    ...
    .line 328
    .local v0, highTempeIntent:Landroid/content/Intent;
    const-string v2, "ktouch.intent.action.BATTERY_TEMPE_HIGH"
    ...
    const-string v3, "TEMPE_HIGH sent"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 348
    .end local v0           #highTempeIntent:Landroid/content/Intent;
    :cond_0
    :goto_0
    return-void
    ...
    invoke-virtual {v2}, Lcom/android/server/BatteryService$TemperatureQueue;->isNormal()Z

    move-result v2

    if-eqz v2, :cond_0

    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mSendNormalTempeIntent:Z

    if-eqz v2, :cond_0

    .line 333
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mSendHighTempeIntent:Z
    ...
    .line 336
    .local v1, normalTempeIntent:Landroid/content/Intent;
    const-string v2, "ktouch.intent.action.BATTERY_TEMPE_NORMAL"
    ...
    const-string v3, "TEMPE_NORMAL sent"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 341
    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mObserving:Z

    if-eqz v2, :cond_0

    .line 342
    iget-object v2, p0, Lcom/android/server/BatteryService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v3, p0, Lcom/android/server/BatteryService;->tempeChangedIntent:Landroid/app/PendingIntent;
...
.method private final shutdownIfNoPower()V
    ...
    .line 290
    .local v1, keyguardLock:Landroid/app/KeyguardManager$KeyguardLock;
    ...
    .end local v1           #keyguardLock:Landroid/app/KeyguardManager$KeyguardLock;
