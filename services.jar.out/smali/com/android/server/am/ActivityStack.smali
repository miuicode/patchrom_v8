...
.field public mCpuClient:Lcom/nvidia/NvCpuClient;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 381
    new-instance v1, Lcom/nvidia/NvCpuClient;

    invoke-direct {v1}, Lcom/nvidia/NvCpuClient;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->mCpuClient:Lcom/nvidia/NvCpuClient;
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ[Lcom/android/server/am/ActivityRecord;)I
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mCpuClient:Lcom/nvidia/NvCpuClient;

    invoke-virtual/range {v3 .. v8}, Lcom/nvidia/NvCpuClient;->requestMinOnlineCpuCount(IJJ)V

    .line 2298
    move-object/from16 v0, p0

    iget-object v9, v0, Lcom/android/server/am/ActivityStack;->mCpuClient:Lcom/nvidia/NvCpuClient;
    ...
    invoke-virtual/range {v9 .. v14}, Lcom/nvidia/NvCpuClient;->pokeCPU(IJJ)V
    ...
    invoke-virtual {v0, v10, v13, v14}, Landroid/content/Intent;->toShortString(ZZZ)Ljava/lang/String;
    ...
    .line 2304
    .end local v4           #minOnlineCpu:I
    .end local v5           #pokeTimeout:J
    .end local v7           #now:J
    :cond_2
    const/16 v34, 0x0
    ...
    .line 2290
    .restart local v5       #pokeTimeout:J
    ...
    invoke-static {v3}, Lcom/nvidia/NvAppSpecificHeuristics;->getAppSpecificMinOnlineCpuOnStartup(Ljava/lang/String;)I

    move-result v4

    .restart local v4       #minOnlineCpu:I
    goto/16 :goto_1
    ...
    const-string v9, "Permission Denial: starting "
    ...
    iget-object v9, v0, Landroid/content/pm/ActivityInfo;->permission:Ljava/lang/String;
    ...
    invoke-interface {v3, v0, v9}, Landroid/app/IActivityController;->activityStarting(Landroid/content/Intent;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct/range {v12 .. v24}, Lcom/android/server/am/ActivityRecord;-><init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ProcessRecord;ILandroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZ)V
    ...
    const-string v9, "Activity start"

    move/from16 v0, p10

    move/from16 v1, p11

    invoke-virtual {v3, v0, v1, v9}, Lcom/android/server/am/ActivityManagerService;->checkAppSwitchAllowedLocked(IILjava/lang/String;)Z
    ...
    .line 2422
    new-instance v32, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;

    invoke-direct/range {v32 .. v32}, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;-><init>()V

    .line 2423
    .local v32, pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    move-object/from16 v0, v32

    iput-object v12, v0, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;->r:Lcom/android/server/am/ActivityRecord;
    ...
    .line 2434
    .end local v32           #pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    :cond_15
    move-object/from16 v0, p0
    ...
    iput-wide v9, v3, Lcom/android/server/am/ActivityManagerService;->mAppSwitchesAllowedTime:J
    ...
    invoke-virtual {v3, v9}, Lcom/android/server/am/ActivityManagerService;->doPendingActivityLaunchesLocked(Z)V
    ...
    invoke-virtual/range {v13 .. v19}, Lcom/android/server/am/ActivityStack;->startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;[Landroid/net/Uri;IZZ)I
    ...
    iput-boolean v9, v3, Lcom/android/server/am/ActivityManagerService;->mDidAppSwitch:Z
