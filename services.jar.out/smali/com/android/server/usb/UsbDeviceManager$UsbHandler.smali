...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    iput-object v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$500(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    .line 392
    const-string v6, "cn.ktouch.connectioncomplete"
    ...
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private updateUsbNotification()V
    ...
    const-string v9, "persist.sys.ty.ums"
    ...
    #setter for: Lcom/android/server/usb/UsbDeviceManager;->mUseUsbNotification:Z
    invoke-static {v8, v12}, Lcom/android/server/usb/UsbDeviceManager;->access$2402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    const-string v10, "--->>>  mUseUsbNotification = "
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mNotificationManager:Landroid/app/NotificationManager;
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$2500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mUseUsbNotification:Z
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$2400(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    #setter for: Lcom/android/server/usb/UsbDeviceManager;->mUseUsbNotification:Z
    invoke-static {v8, v11}, Lcom/android/server/usb/UsbDeviceManager;->access$2402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .line 712
    .local v0, currProp:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$200()Ljava/lang/String;
    ...
    const-string v10, "--->>> updateUsbNotification::persist.sys.usb.config = "
    ...
    const-string v10, "--->>> mCurrentFunctions = "
    ...
    .line 751
    iput v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbNotificationId:I

    .line 753
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$302(Z)Z
    ...
    const-string v9, "mNotificationManager.cancel"
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->UsbConnectedMode:Ljava/lang/String;
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$500(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    .line 760
    invoke-static {v12}, Lcom/android/server/usb/UsbDeviceManager;->access$302(Z)Z
    ...
    const-string v9, "mNotificationManager.notify"
    ...
    invoke-static {v8, v11, v2, v11}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v4, v8, v7, v3, v5}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v8, v1, v4}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V
    ...
    const-string v9, "No known USB function in updateUsbNotification"
...
.method private updateUsbState()V
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->UsbConnectedMode:Ljava/lang/String;
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$500(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    const-string v7, "persist.sys.ty.ums"
    ...
    const-string v8, "--->>> sendBroadcast ums mConnected = "
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->UMSConnectedIntent:Landroid/content/Intent;
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2200(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Intent;
    ...
    .line 596
    const-string v6, "persist.sys.ty.ums"
    ...
    .line 597
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$702(Z)Z
    ...
    const-string v8, "--->>> disConnected ums:0 adbEnable="
    ...
    const-string v7, "mass_storage,adb"

    invoke-virtual {v6, v7, v5}, Lcom/android/server/usb/UsbDeviceManager;->setCurrentFunction(Ljava/lang/String;Z)V
    ...
    const-string v7, "updateUsbState rndis"
    ...
    .line 626
    .local v1, currProp:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$200()Ljava/lang/String;
    ...
    const-string v8, "--->>> updateUsbState::persist.sys.usb.config = "
    ...
    .line 592
    .end local v1           #currProp:Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->UMSDisConnectedIntent:Landroid/content/Intent;
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2300(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Intent;
    ...
    .end local v0           #adbEnable:Z
    :cond_6
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager;->access$402(Z)Z
    ...
    const-string v6, "updateUsbState sendStickyBroadcast new"
    ...
    .line 636
    .restart local v1       #currProp:Ljava/lang/String;
    :cond_7
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v2, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$2100(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
...
.method public updateState(Ljava/lang/String;)V
    ...
    const-string v5, ">>>>noDelayed msg.connected="
